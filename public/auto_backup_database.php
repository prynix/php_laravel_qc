...
//chỉnh cho 3 phiên bản: localhost, staging, server
...
$db_server = $host; // your MySQL server - localhost will normally suffice
...
$from_emailaddress = "daotientu@gmail.com";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "tudt@tintuc.vn";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "tudt@tintuc.vn"; // your email address to send backup files to
...
define('LOCATION', dirname(__FILE__) ."/includes/");
