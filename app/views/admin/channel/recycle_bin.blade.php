                                        ...
                                        <tbody>
                                            @foreach($channels as $channel) 
                                                <tr>
                                                    ...
                                                    <td align="center"><a href="{{URL::to('admin/channel-revert-'.$channel->id)}}" title="Restore"><button class="btn-sm btn-default"><i class="fa fa-undo"></i></button></a></td>
                                                    <td align="center"><a href="{{URL::to('admin/channel-destroy-'.$channel->id)}}" title="Delete" channelid="{{$channel->id}}" onclick="return confirm('Are you sure you want to permanently delete this record? \n{{$channel->name}} \nDate modified: {{$channel->updated_at}}')"><button class="btn-sm btn-default"><i class="fa fa-trash-o"></i></button></a></td>
                                                </tr>
                                            @endforeach   
                                        </tbody>
                                        <tfoot>
