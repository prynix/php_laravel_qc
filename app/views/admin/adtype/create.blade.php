...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add new ad type</li>
                    </ol>
                </section>
                                ...
                                {{Form::open()}}
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::input('number','width',Input::old('width'),array('class'=>'form-control','placeholder'=>'Enter ...','style'=>'width:20%;'))}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::input('number','height',Input::old('height'),array('class'=>'form-control','placeholder'=>'Enter ...','style'=>'width:20%;'))}}
