...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Copy a link to click tracking
                        <!-- <small>Preview</small> -->
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="ccount"> Click Counter</a></li>
                        <li class="active">Copy link</li>
                    </ol>
                </section>
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('url',Input::old('url',$banner->url),array('class'=>'form-control','placeholder'=>'http://www.example.com'))}}
                                        <p class="help-block">URL of the link you wish to count clicks on.</p>
                                    </div>
                                    <div class="form-group">
                                        {{Form::label('title','Link title')}}
                                        {{Form::text('title',Input::old('title',$banner->title),array('class'=>'form-control','placeholder'=>'(optional) My page title'))}}
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-success">Copy this link</button>
                                </div><!-- /.box-footer -->
                                {{Form::close()}}
                                <!-- form end -->
                            </div><!-- /.box -->
