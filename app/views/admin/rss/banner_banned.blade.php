			...
			<div class="box box-warning">
				<div class="box-header" style="padding-bottom: 0;">
					@if(is_string($topic_selected))
						<a href="rss-feed-{{$website_id}}"
						style="display: inline-block; margin: 10px 10px 0 10px;"><button
							class="btn btn-default">Actived Ads&nbsp;({{$actived_ads}})</button></a>				
					@else
						<a href="rss-banner-{{$website_id}}-{{$topic_selected->id}}"
						style="display: inline-block; margin: 10px 10px 0 10px;"><button
							class="btn btn-default">Actived Ads&nbsp;({{$actived_ads}})</button></a>
					@endif
					<a href="#"
						style="display: inline-block; margin: 10px 10px 0 0;"><button
							class="btn bg-yellow">Banned Ads&nbsp;({{$banned_ads}})</button></a>
					@if(is_string($topic_selected))
					...
					<table id="example2" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{HTML::image($adbanner->imagefile,'',array('onerror'=>"this.onerror=null;this.src='http://localhost/ad/public/assets/img/icon/no_image.jpg'",'width'=>'50px'))}}&nbsp;<a
									href="{{$adbanner->adbanner_link}}" target="_blank">{{$adbanner->adbanner_title}}</a></td>
								...
								<td align="center"><a href="{{URL::to('admin/rss-deny_adbanner-'.$website_id.'-'.$adbanner->id)}}">{{HTML::image('assets/img/icon/document_revert.png','Revert',array('title'=>'Revert','width'=>'20px'))}}</a></td>
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="box">
														...
														{{Form::open(array('url'=>'admin/rss-adbanner-edit-'.$website_id.'-'.$adbanner->id,'files'=>true))}}
														<div class="box-body">
															<div class="form-group">
															...
															<div class="form-group">
																...
																{{HTML::image("$adbanner->imagefile",'',array('style'=>'margin-bottom:10px;'))}}
															...
															<div class="form-group">
																...
																<div class="input-group">
																	...
																	{{Form::text('expire_date',Input::old('expire_date',$adbanner->expire_date),array('class'=>'form-control expire_date','style'=>'width:auto;'))}}
																</div>
															</div>
...
<!-- 											class="horizontal flat-red" value="1" />&nbsp;Theo hàng ngang</label> -->
					...
					<div class="col-xs-12">
						<div class="box box-warning box-display" style="overflow-x:hidden;overflow-y:hidden;">
							...
							<div class="box-body clearfix" style="padding:0 10px 0 10px;">
							     <div class="vertical_display">
							         <ul class="clearfix" style="width:340px;height:414px;padding:0;overflow-y:scroll;">
							             <li style="float:left;height:138px;padding:5px;border-bottom:1px dashed #ccc;">
