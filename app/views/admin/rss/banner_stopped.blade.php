		...
		<div class="col-xs-10">
			<div class="box box-warning">
				<div class="box-header" style="padding-bottom: 0;">
					...
					<a href="#"
						style="display: inline-block; margin: 10px 10px 0 0;"><button
							class="btn bg-yellow">Stopped Ads&nbsp;({{$stopped_ads}})</button></a>
				</div>
				<div class="box-body table-responsive">
					...
					<table id="example2" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><a
									href="{{URL::to('admin/rss-destroy_adbanner-'.$website_id.'-'.$adbanner->id)}}" title="" onclick="return confirm('Are you sure you want to permanently delete this banner? \n{{str_replace('"','',$adbanner->adbanner_title)}} \nDate modified: {{$adbanner->updated_at}}')">{{HTML::image('assets/img/icon/delete.png','Delete',array('title'=>'Delete'))}}</a></td>
							</tr>
							<!-- Modal -->
