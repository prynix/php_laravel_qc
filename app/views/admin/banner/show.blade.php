...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Show banner<span class="target">: {{$banner->description}}</span>
                        <!-- <small>Preview</small> -->
                    </h1>
                    <ol class="breadcrumb">
              ...
              @endif
                                ...
                                <!-- form start -->
                                    <div class="box-body">
                        				...
                        				{{Form::close()}}
                                        <a href="{{URL::to('admin/banner')}}"><button class="btn-sm btn-default"><i class="fa fa-arrow-circle-o-left">&nbsp;Back</i></button></a>
                                    </div><!-- /.box-body -->
                            </div><!-- /.box -->
						</div><!--/.col (right) -->
                        <!--<div class="col-md-6">
