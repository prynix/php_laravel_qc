	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<!-- /.box-header -->
				<a href="website-partner_new-{{$website_id}}"
					style="display: inline-block; margin-left: 10px;"><button
						class="btn btn-default">New</button></a> <a
					href="website-partner-{{$website_id}}"
					style="display: inline-block; margin-left: 10px;"><button
						class="btn btn-default">Active</button></a> <a href="#"
					style="display: inline-block; margin-left: 10px;"><button
						class="btn bg-red">Banned</button></a>
								...
								<div class="box-body">
									...
									<div class="form-group">
										{{Form::label('website_topic_id','Topic')}} <select
											...
											tabindex="1" name="website_topic_id[]" multiple
											data-rel="chosen">
									...
									<div class="form-group">
										...
										!important;width:auto;margin-left:3px;'))}}</div>
...
?>
								...
								<td align="center"><a
									...
									title="Deny" class="btn-sm btn-primary">Accept</a></td>
								<td align="center"><a
									href="{{URL::to('admin/website-delete_partner-'.$website_id.'-'.$partner->id)}}" title="" onclick="return confirm('Are you sure you want to permanently delete this partner? \n{{$partner->name}} \nDate modified: {{$partner->updated_at}}')">{{HTML::image('assets/img/icon/delete.png','Delete',array('title'=>'Delete'))}}</a></td>
							</tr>
							@endforeach()
						</tbody>
						<tfoot>
