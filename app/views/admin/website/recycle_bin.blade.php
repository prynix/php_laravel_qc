                                        ...
                                        <tbody>
                                            @foreach($websites as $website) 
                                                <tr>
                                                    ...
                                                    <td align="center"><a href="{{URL::to('admin/website-revert-'.$website->id)}}" title="Restore"><button class="btn-sm btn-default">
                                            <i class="fa fa-undo"></i>
                                        </button></a></td>
                                                    <td align="center"><a href="{{URL::to('admin/website-destroy-'.$website->id)}}" title="Delete"><button class="btn-sm btn-default" onclick="return confirm('Are you sure you want to permanently delete this record? \n{{$website->name}} \nDate modified: {{$website->updated_at}}')" onclick="return confirm('Are you sure you want to permanently delete this record? \n {{$website->name}} \n Date modified:  {{$website->updated_at}}')"><i class="fa fa-trash-o"></i></button></a></td>
                                                </tr>
                                            @endforeach   
                                        </tbody>
                                        <tfoot>
