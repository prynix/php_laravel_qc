...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Show user<span class="target">: {{$user->username}}</span>
                        <!-- <small>Preview</small> -->
                    </h1>
                    <ol class="breadcrumb">
              ...
              @endif
                                ...
                                <!-- form start -->
                                    ...
                                    <div class="box-footer">
                                        <a href="{{URL::to('admin/user')}}"><button class="btn-sm btn-default"><i class="fa fa-arrow-circle-o-left">&nbsp;Back</i></button></a>
                                    </div>
                            </div><!-- /.box -->
						</div><!--/.col (right) -->
                    </div>   <!-- /.row -->
