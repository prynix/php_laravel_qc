...
<section class="content-header">
  <h1> Edit campaign<span class="target">: {{$campaign->campaignname}}</span>
    <!-- <small>Preview</small> -->
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          ...
          <button type="submit" class="btn-sm btn-success"><i class="fa fa-check-circle-o"></i>&nbsp;Save</button> </div>
      </div>
      <!-- /.box -->
    </div>
    <!--/.col (right) -->
