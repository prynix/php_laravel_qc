...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Edit campaign<span class="target">: {{$campaign->campaignname}}</span>
                        <!-- <small>Preview</small> -->
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    @foreach($advertisers as $advertiser)
                                                @if($campaign->clientid==$advertiser->id)
                                                    <a href="{{URL::to('admin/advertiser-edit-'.$advertiser->id)}}" title="">Advertiser: {{ $advertiser->clientname }}</a>
                                                @else
                                                @endif
                                            @endforeach
                </section>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
	                                            ...
	                                            {{Form::text('campaignname',Input::old('campaignname',$campaign->campaignname),array('class'=>'form-control'))}}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
	                                            ...
	                                            {{Form::text('active',Input::old('active',$campaign->active),array('class'=>'form-control','style'=>'width:auto;'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                            	{{Form::text('expire',Input::old('expire',$campaign->expire),array('class'=>'form-control','style'=>'width:auto;'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                            	...
                                            	{{Form::text('revenue',Input::old('revenue',$campaign->revenue),array('class'=>'form-control','style'=>'width:auto;'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('clicks','Clicks')}}
                                            {{Form::input('number','clicks',Input::old('clicks',$campaign->clicks),array('class'=>'form-control','min'=>0,'style'=>'width:auto;'))}}                            
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            {{Form::input('number','session_capping',Input::old('session_capping',$campaign->session_capping),array('class'=>'form-control','style'=>'display:inline-block;width:auto;'))}}
                                            &nbsp;per session
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('comments','Comments')}}
                                            {{Form::textarea('comments',Input::old('comments',$campaign->comments),array('class'=>'form-control','rows'=>3))}}
                                        </div>
