...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Campaign<span class="target">: {{$campaign->campaignname}}</span>
                        <!-- <small>Preview</small> -->
                    </h1>
                    <ol class="breadcrumb">
                                ...
                                {{HTML::ul($errors->all())}}
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            {{Form::label('campaignname','Name')}}&nbsp;<font color="#FF0000">*</font>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-bar-chart-o"></i></span>
                                            	{{Form::text('campaignname',Input::old('campaignname',$campaign->campaignname),array('class'=>'form-control','disabled'=>'disabled'))}}
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('revenue_type','Campaign type')}}
                                        </div>
                                        <div class="form-group"> 
                                            ...
                                            @endif
                                            &nbsp;Remnant<br/>
                                            <font style="font-weight:normal;">This is a standard campaign which can be constrained with either an end date or a specific limit</font> 
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @endif
                                            &nbsp;Contract<br/>
                                            <font style="font-weight:normal;">This campaign is limited per day and is going to be delivered evenly until the end date or specified limit is met</font>                    
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <font style="font-weight:normal;">This campaign is going to take all impressions and be delivered before other campaigns</font>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('active','Start date')}}
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
	                                            {{Form::text('active',Input::old('active',$campaign->active),array('class'=>'form-control datetimepicker','style'=>'width:auto;','disabled'=>'disabled'))}}
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('expire','End date')}}
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                            	{{Form::text('expire',Input::old('expire',$campaign->expire),array('class'=>'form-control datetimepicker','style'=>'width:auto;','disabled'=>'disabled'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('revenue_type','Pricing model')}}&nbsp;<font color="#FF0000">*</font>
                                        ...
                                        <div class="form-group">
                                            {{Form::label('revenue','Rate / Price')}}
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-eur"></i></span>
	                                            {{Form::text('revenue',Input::old('revenue',$campaign->revenue),array('class'=>'form-control','style'=>'width:auto;','disabled'=>'disabled'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('clicks','Clicks')}}
                                            {{Form::input('number','clicks',Input::old('clicks',$campaign->clicks),array('class'=>'form-control','min'=>0,'style'=>'width:auto;','disabled'=>'disabled'))}}                            
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('','Priority level')}}<br/>
                                        ...
                                        <div class="form-group">
                                            {{Form::label('capping','Limit campaign views to')}}<br/>
                                        ...
                                        <div class="form-group">
                                            {{Form::input('number','session_capping',Input::old('session_capping',$campaign->session_capping),array('class'=>'form-control','style'=>'display:inline-block;width:auto;','disabled'=>'disabled'))}}
                                            &nbsp;per session
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('comments','Comments')}}
                                            {{Form::textarea('comments',Input::old('comments',$campaign->comments),array('class'=>'form-control','rows'=>3,'disabled'=>'disabled'))}}
                                        </div>
